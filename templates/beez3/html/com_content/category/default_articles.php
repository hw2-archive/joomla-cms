...
<?php namespace Hwj; namespace Hwj; else : ?>
...
<?php namespace Hwj; namespace Hwj; namespace Hwj; // Code to add a link to submit an article. ?>
<?php namespace Hwj; namespace Hwj; namespace Hwj; if ($this->category->getParams()->get('access-create')) : ?>
	<?php echo JHtml::_('icon.create', $this->category, $this->category->params, array(), true); ?>
<?php namespace Hwj; namespace Hwj; namespace Hwj;  endif; ?>

<?php namespace Hwj; namespace Hwj; namespace Hwj; // Add pagination links ?>
<?php namespace Hwj; namespace Hwj; namespace Hwj; if (!empty($this->items)) : ?>
