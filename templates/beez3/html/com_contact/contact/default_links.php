...
<?php endif; ?>
<?php namespace Hwj; namespace Hwj; if  ($this->params->get('presentation_style') == 'plain'):?>
<?php namespace Hwj; namespace Hwj; namespace Hwj; echo '<h3>'. JText::_('JGLOBAL_ARTICLES').'</h3>'; ?>
...
<?php namespace Hwj; namespace Hwj; namespace Hwj; if ($this->params->get('presentation_style') == 'sliders'):?>
		</div>
	</div>
</div>
<?php namespace Hwj; namespace Hwj; namespace Hwj; endif; ?>
