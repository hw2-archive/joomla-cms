...
if (my_class_exists_d('PHP_CodeSniffer_Standards_AbstractPatternSniff', true) === false) {
	throw new PHP_CodeSniffer_\Exception('Class PHP_CodeSniffer_Standards_AbstractPatternSniff not found');
}
