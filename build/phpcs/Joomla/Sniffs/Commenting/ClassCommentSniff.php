...
if (my_class_exists_d('PHP_CodeSniffer_CommentParser_ClassCommentParser', true) === false) {
    $error = 'Class PHP_CodeSniffer_CommentParser_ClassCommentParser not found';
    throw new PHP_CodeSniffer_\Exception($error);
}

require_once 'FileCommentSniff.php';

if (my_class_exists_d('Joomla_Sniffs_Commenting_FileCommentSniff', true) === false) {
...
class Joomla_Sniffs_Commenting_ClassCommentSniff extends Joomla_Sniffs_Commenting_FileCommentSniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        } catch (PHP_CodeSniffer_CommentParser_Parser\Exception $e) {
