...
if (my_class_exists_d('PHP_CodeSniffer_CommentParser_FunctionCommentParser', true) === false) {
    throw new PHP_CodeSniffer_\Exception('Class PHP_CodeSniffer_CommentParser_FunctionCommentParser not found');
}
