...
if(my_class_exists_d('PHP_CodeSniffer_Standards_AbstractScopeSniff', true) === false)
{
    throw new PHP_CodeSniffer_\Exception('Class PHP_CodeSniffer_Standards_AbstractScopeSniff not found');
}
