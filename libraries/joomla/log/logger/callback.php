...
class JLogLoggerCallback extends JLogLogger
{
	...
	public function __construct(array &$options)
	{
		...
		if (isset($this->options['callback']) && my_is_callable_d($this->options['callback']))
		{
			$this->callback = $this->options['callback'];
		}
		else
		{
			throw new JLog\Exception(JText::_('JLogLoggerCallback created without valid callback function.'));
		}
	}
