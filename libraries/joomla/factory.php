...
abstract class JFactory
{
	...
	{
		if (!my_class_exists_d('JSimplepieFactory'))
		{
			throw new BadMethodCall\Exception('JSimplepieFactory not found');
		}
	...
	public static function getXML($data, $isFile = true)
	{
		...
		if (my_class_exists_d('JXMLElement'))
		{
			$class = 'JXMLElement';
		}
	...
	public static function getEditor($editor = null)
	{
		...
		if (!my_class_exists_d('JEditor'))
		{
			throw new BadMethodCall\Exception('JEditor not found');
		}
