...
class JEventDispatcher extends JObject
{
	...
	public function attach($observer)
	{
		...
		{
			if (!isset($observer['handler']) || !isset($observer['event']) || !my_is_callable_d($observer['handler']))
			{
				return;
			}
		...
		else
		{
			...
			$this->_observers[] = $observer;
			$methods = array_diff(my_get_class_methods($observer), my_get_class_methods_d('JPlugin'));
		}
