...
class JComponentHelper
{
	...
	public static function renderComponent($option, $params = array())
	{
		...
		my_define_d('JPATH_COMPONENT', JPATH_BASE . '/components/' . $option);
		my_define_d('JPATH_COMPONENT_SITE', JPATH_SITE . '/components/' . $option);
		my_define_d('JPATH_COMPONENT_ADMINISTRATOR', JPATH_ADMINISTRATOR . '/components/' . $option);
