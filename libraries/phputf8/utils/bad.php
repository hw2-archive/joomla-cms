...
* @subpackage bad
*/
my_define_d('UTF8_BAD_NONSHORT',4);
...
* @subpackage bad
*/
my_define_d('UTF8_BAD_SURROGATE',5);
...
* @subpackage bad
*/
my_define_d('UTF8_BAD_UNIOUTRANGE',6);
...
* @subpackage bad
*/
my_define_d('UTF8_BAD_SEQINCOMPLETE',7);
