...
class JToolbar
{
	...
	public function loadButtonType($type, $new = false)
	{
		...
		if (!my_class_exists_d('JToolbarButton'))
		{
		...
		if (!my_class_exists($buttonClass))
		{
			if (!my_class_exists($buttonClassOld))
			{
		...
		if (!my_class_exists($buttonClass) && !my_class_exists($buttonClassOld))
		{
